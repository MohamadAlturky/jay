...
const WHATSAPP_NUMBER = "963980775725";
...
const ArtworkDetail = () => {
  ...
  const inquiryUrl = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`Hi Jay! I'd love to know more about "${artwork.title}".`)}`;

  return (
    <>
      <Helmet>
        <title>{artwork.title} — Jay</title>
        <meta
          name="description"
          content={`${artwork.title} by Jay. ${artwork.medium}, ${artwork.dimensions}. ${artwork.description.substring(0, 150)}...`}
        />
      </Helmet>
